 ...
 * ---------------------------------------------------------------------------------------------------------------------
 */
#ifndef ARTSLAM_ODOM_H
#define ARTSLAM_ODOM_H
...
namespace artslam
{
    namespace laser3d
    {
         ...
         * ...
         */
        class ARTSLAMOdom : public ARTSLAMSensor<sensor_msgs::PointCloud2ConstPtr>  // TODO: change msg type
        {
        public:
            ARTSLAMOdom(int id, std::string topic, int buffer)
            {
                _prefilterer = true;
                _tracker = true;
            ...
            {
                sensor_sub = mt_nh->subscribe(_topic, _buffer, &artslam::laser3d::ARTSLAMOdom::callback, this);
            };
