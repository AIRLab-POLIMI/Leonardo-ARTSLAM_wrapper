 ...
 * ---------------------------------------------------------------------------------------------------------------------
 */
#ifndef ARTSLAM_RADAR_H
#define ARTSLAM_RADAR_H
...
namespace artslam
{
    namespace laser3d
    {
         ...
         * ...
         */
        class ARTSLAMRadar : public ARTSLAMSensor<sensor_msgs::PointCloud2ConstPtr>  // TODO: change msg type
        {
        public:
            ARTSLAMRadar(int id, std::string topic, int buffer)
            {
                _prefilterer = true;
                _tracker = true;
            ...
            {
                sensor_sub = mt_nh->subscribe(_topic, _buffer, &artslam::laser3d::ARTSLAMRadar::callback, this);
            };
